...
import { getSupervisorRequestsAPI, approveSupervisorRequestAPI, rejectSupervisorRequestAPI } from '../../../lib/api';
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                 {requests.map(req => (
                    <div key={req.id} className="bg-white border rounded-xl p-6 shadow-[0_2px_10px_rgba(0,0,0,0.02)] flex flex-col">
                       <span className="text-xs font-bold bg-orange-100 text-orange-600 px-2 py-1 rounded uppercase tracking-wider mb-4">Pending</span>
